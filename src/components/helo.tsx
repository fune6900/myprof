...
export const Helo = () => {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen text-center bg-cyber-black mx-auto px-4">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 4.0, delay: 0.3 }}>
        <img
          src={fune}
        ...
        {/* 下スクロールテキスト */}
        <p className="absolute bottom-20 left-1/2 -translate-x-1/2 text-xs md:text-sm text-neon-white">
          Scroll Down
        </p>
